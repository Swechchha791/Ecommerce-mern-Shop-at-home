...
const AdminEditProductCard = ({ onClose, productData, fetchdata }) => {
  ...
  // Edit the Product card Image in Edit product card section
  const handleUploadProductCard = async (e) => {
  ...
  // Delete product Image in Edit product card section
  ...
  //  Handler to Update product section
            ...
            <div className="p-2 bg-indigo-100 border rounded h-32 w-full flex justify-center items-center cursor-pointer">
              <div className="text-indigo-500 flex justify-center items-center flex-col gap-2">
                ...
                <input
                  ...
                  id="uploadImageInput"
                  className="hidden"
                  onChange={handleUploadProductCard}
                />
              </div>
            </div>
          </label>
