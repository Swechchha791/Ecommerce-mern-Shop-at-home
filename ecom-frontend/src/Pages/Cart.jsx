      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:justify-between p-4">
            ...
            : data.map((product, index) => {
                return (
                  <div
                    ...
                    className="w-full bg-white h-32 my-2 border border-indigo-300  rounded grid grid-cols-[128px,1fr]"
                  >
                    ...
                    <div className="px-4 py-2 relative">
                      {/* Delete product */}
                      <div
                        className="absolute right-0 text-indigo-600 rounded-full p-2 hover:bg-indigo-600 hover:text-white cursor-pointer"
        ...
        <div className="mt-5 lg:mt-0 w-full max-w-sm">
          {loading ? (
            ...
            <div className="h-36 bg-white font-medium">
              ...
              <button className="bg-indigo-600 p-2 text-white w-full mt-2 rounded-2xl hover:bg-indigo-700">
                Payment
              </button>
            </div>
          )}
